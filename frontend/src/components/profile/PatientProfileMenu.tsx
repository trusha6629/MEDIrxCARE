      ...
      <DropdownMenuTrigger asChild>
        <button className="flex items-center gap-3 rounded-xl border-l border-gray-200 py-1.5 pl-4 pr-3 transition-all hover:bg-gray-50 dark:border-slate-800 dark:hover:bg-slate-900">
          <div className="text-right">
            <p className="text-sm font-medium text-gray-900 dark:text-slate-100">{user?.name || "Rohan Verma"}</p>
            <p className="text-xs text-gray-500 dark:text-slate-400">Patient Portal</p>
          </div>
        ...
        <div className="rounded-t-2xl bg-gradient-to-br from-cyan-600 to-teal-500 p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="text-white">
              <h3 className="text-base font-semibold leading-tight">{user?.name || "Rohan Verma"}</h3>
              <p className="mt-0.5 text-xs text-cyan-100">Patient Portal</p>
        ...
        <div className="p-2">
          ...
          <DropdownMenuGroup>
            <DropdownMenuItem asChild>
              <Link to="/dashboard/settings" className="flex cursor-pointer items-center gap-3 rounded-lg px-3 py-2.5">
            ...
            <DropdownMenuItem asChild>
              <Link to="/dashboard/reports" className="flex cursor-pointer items-center gap-3 rounded-lg px-3 py-2.5">
                <Activity className="w-4 h-4 text-gray-500" />
                <span className="text-sm text-gray-700 dark:text-slate-200">Health History</span>
                <ChevronRight className="ml-auto w-4 h-4 text-gray-400" />
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              ...
              >
                ...
                <span className="text-sm text-gray-700 dark:text-slate-200">My Appointments</span>
                <ChevronRight className="ml-auto w-4 h-4 text-gray-400" />
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              <Link to="/dashboard/reports" className="flex cursor-pointer items-center gap-3 rounded-lg px-3 py-2.5">
                ...
                <span className="text-sm text-gray-700 dark:text-slate-200">Medical Reports</span>
                <ChevronRight className="ml-auto w-4 h-4 text-gray-400" />
              </Link>
            </DropdownMenuItem>
          </DropdownMenuGroup>
